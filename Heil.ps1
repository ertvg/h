...
[System.Windows.Forms.MessageBox]::Show("Heil ! Bienvenue en Allemagne Nazi !", "Willkommen", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
