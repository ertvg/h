...
$image =  "https://github.com/ertvg/h/blob/main/js.png"

$i = -join($image,"?dl=1")
iwr $i -O $env:TMP\i.png

iwr https://github.com/ertvg/h/blob/main/js.png?dl=1 -O $env:TMP\i.png

# Download WAV file; replace link to $wav to add your own sound

$wav = "https://github.com/ertvg/h/blob/main/jsw.wav?raw=true"
