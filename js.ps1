...
Invoke-WebRequest https://github.com/ertvg/h/blob/main/js.png -OutFile C:\Temp\js.png
# Téléchargement du son
Invoke-WebRequest https://github.com/ertvg/h/blob/main/js.wav -OutFile C:\Temp\js.wav
